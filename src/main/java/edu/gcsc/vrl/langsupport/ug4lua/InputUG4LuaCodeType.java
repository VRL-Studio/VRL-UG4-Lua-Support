 ...
 */
@TypeInfo(type = String.class, input = true, output = false, style = "ug4lua-code")
public class InputUG4LuaCodeType extends InputLuaCodeType {
    
    @Override
    protected VCodeEditor createEditor() {
        return EditorProvider.getEditor("ug4lua", this);
    }
